...
#Extracting Labels
df=pd.read_csv('/home/cse/mtech/mcs172873/Labels/VillageLabels_MSW.csv')  # --> Contain village label
...
all_img = []
all_label = np.array([])
train_path = "/scratch/cse/mtech/mcs172873/data_landsat/msw/train/"  # --> Contains Satellite images
...
test_path =  "/scratch/cse/mtech/mcs172873/data_landsat/msw/test/" # --> Contains Satellite images
...
model_save_path = "/scratch/cse/mtech/mcs172873/12bands.pt"
