...
# 1. test_images_path (LINE 44 - path where test images are present)
# 2. weights_path - LINE 45, 46, 47 (Basically put the paths of all the weights in weights_path list)
# 3. pd.read_csv('/home/cse/mtech/mcs172873/Labels/VillageLabels_BF.csv') - LINE 50
# 4. Last lines (where we save the outputs) - LINE 245
# ----------------------------------------------------------------------------------------------------------------
# path variables
test_images_path = "/scratch/cse/mtech/mcs172873/All_Images_Landsat2001"
weights_path = ['/scratch/cse/mtech/mcs172873/weights/resnet_imbalance_landat2011/bf/weights-improvement-02.hdf5', 
...
for m in model_weight:
	...
	path_file = '/home/cse/mtech/mcs172873/Test_Run/Test_Results_BF-0{}.csv'.format(counter+2)  # The path where you want to save result
