...
# 1. test_images_path (LINE 46 - path where test images are present)
...
weights_path = ['/scratch/cse/mtech/mcs172873/weights/resnet_imbalance_landat2011/emp/weights-improvement-02.hdf5', 
...
for m in model_weight:
	...
	path_file = '/home/cse/mtech/mcs172873/Test_Run/Test_Results_EMP-0{}.csv'.format(counter+2)
